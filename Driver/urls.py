...
urlpatterns = [
	...
	path('get-driver-normal-orders/<int:pk>/<str:date>', views.GetTodaysOrders.as_view()),
	path('get-driver-food-package-orders/<int:pk>/<str:date>', views.GetTodaysFoodPackageOrders.as_view()),
